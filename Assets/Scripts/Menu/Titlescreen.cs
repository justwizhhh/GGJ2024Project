...
public class Titlescreen : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Menus navigation
        MenuCursor.position = current_menu_button.position + new Vector3((-current_menu_button.rect.width / 2) - MenuCursorSpace, 0, 0);
        switch (current_title_state)
        {
            ...
            case title_states.OPTIONS:
                ...
                int toggle_input = Input.GetKeyDown(KeyCode.LeftArrow) ? -1 : Input.GetKeyDown(KeyCode.RightArrow) ? 1 : 0;
                switch (current_menu_option)
                    {
                        case 0:
                        // Music toggle
                        if (toggle_input != 0)
                        {
                            ...
                            int volumeText = Mathf.RoundToInt(AudioManager.MusicVolume * 100);
                    ...
                    case 1:
                        ...
                        if (toggle_input != 0)
                        {
                            ...
                            int volumeText = Mathf.RoundToInt(AudioManager.SoundVolume * 100);
